...
graph.edge_list[3].put_agent(1, 102, False, 100, 201)
graph.edge_list[2].put_agent(1, 103, True, 100, 201)
...
ge.dijkstras(graph.adj_graph, graph.edge_list, (0,0), 5, 6, False)
