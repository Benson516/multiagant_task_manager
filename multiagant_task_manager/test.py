...
graph.add_one_edge_by_node_name('A','B',True, 1, 1, 5)
graph.add_one_edge_by_node_name('B','C',True, 1, 1, 2)
graph.add_one_edge_by_node_name('C','D',False, 1, 1, 2)
...
res = ge.number_of_connected_components(graph.adj_graph, graph.edge_list, False)
